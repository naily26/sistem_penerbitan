                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-xs btn-light-grey" href="{{ route('kbli.edit', $data->id)}}"><i class="fa fa-edit"></i>
                                            edit</a>
                                        <a class="btn btn-xs btn-light-grey" data-toggle="modal" href="#delete{{$data->id}}"><i class="fa fa-trash-o"></i>
                                            hapus</a>
                                        <a class="btn btn-xs btn-light-grey" href="{{ route('kbli.show',  $data->id)}}"><i class="fa fa-eye"></i>
                                            detail</a>
                                    </td>
                                </tr>
                                <?php $no++ ?>
                                <div id="delete{{$data->id}}" class="modal fade" tabindex="-1" data-width="360" style="display: none;">   
                                    ...
                                    <form action="{{url('kbli/'. $data->id)}}" method="post" enctype="multipart/form-data">
                                        {{ method_field('delete') }}
                                        @csrf
