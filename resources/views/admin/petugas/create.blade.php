								...
								<div class="panel-body">
									<form method="post" action="{{ route('petugas.store') }}" class="form-horizontal">
                                        ...
                                        <div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="kode" placeholder="Kode" id="form-field-1" class="form-control" required>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="jabatan" placeholder="Jabatan" id="form-field-1" class="form-control" required>
											</div>
										</div>
                                        <div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="no_hp" placeholder="Nomor Handphone" id="form-field-1" class="form-control" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" required>
											</div>
										</div>
                                        <div class="form-group">
											...
											<div class="col-sm-9">
												<input type="email" name="email" placeholder="E-mail" id="form-field-1" class="form-control" required>
											</div>
										</div>
                                        <div class="form-group">
